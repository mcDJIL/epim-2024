...
<nav>
        <a href="/">
            ...
            <div class="nav-item-wrapper-mobile">
                ...
                <!-- <a href="page/login-regis/login.php">Login</a> -->
                </div>
            </div>
    </nav>
                ...
                <div class="tickets-wrapper">
                    <div class="left-tickets">
                        ...
                        <?php
                                if ($ticket == 'premium') {
                            ?>
                            <p>Premium seating offers comfort with a good view of the stage. The seats are comfortable and there is ample legroom. Premium ticket holders get priority access to the concert area. You can also enjoy food and drink services which are available for purchase near your seat.
                            </p>
                            <?php
                                }
                            ?>
    ...
    <div class="modal modal-buy">
        <div class="modal-header">
            <p>Please fill in your personal details
            </p>
        ...
        <div class="modal-body">
            ...
            <div class="input-group">
                ...
                <input type="number" name="phone" id="phone" required placeholder="6282261984331">
            </div>
            <div class="input-group">
    ...
    <script>
        ...
        function handleBuyTicket() {
            ...
            if (!LoggedIn) {
                ...
                window.location.href = 'page/login-regis/login.php';
            }
        }
