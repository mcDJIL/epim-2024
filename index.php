    ...
    <section id="hero-section">
        <div class="hero-container">
            <div class="left-hero">
                ...
                <div class="subtitle">
                    <p>Join Us for an Enchanting Night of Live Music Under the Startlit Sky.
                    </p>
                </div>
                ...
                <div class="cta">
                    <button class="btn-events">About Concert</button>
                </div>
            </div>
                ...
                <div class="left-events">
                    ...
                    <div class="events-details">
                        <div class="left-details">
                            ...
                            <div class="details">
                                <p>Kampung Jackloth, Jember
                                </p>
                                <p>Slamet Riyadi street No.168, Patrang District
                                </p>
                            </div>
                        </div>
            ...
            <div class="seats-container">
                ...
                <div class="seats-wrapper">
                    ...
                    <div class="hover-area general-left">
                        <span class="tooltips">Rp 100.000</span>
                    </div>
                    <div class="hover-area general-right">
                        <span class="tooltips">Rp 100.000</span>
                    </div>
                    <div class="hover-area vip">
                        <span class="tooltips">Rp 250.000</span>
                    </div>
                    <div class="hover-area premium">
                        <span class="tooltips">Rp 175.000</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="weather-section">
            <div class="weather-container">
                <div class="weather-title">
                    <h1>Weather Forecast | Saturday, 31 August 2024
                    </h1>
                </div>
